...
export default function UserNovelsList() {
  ...
  const [sortConfig, setSortConfig] = useState({
    key: "title", // id | title | chapters | status | created_at | updated_at
    direction: "asc",
  });
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-md overflow-hidden">
        ...
        <div className="px-4 md:px-5 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => navigate("/workspace/novels/create")}
                ...
                paginated.map((novel) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div
                        onClick={() =>
                          navigate(`/workspace/novels/${novel.id}`)
                        }
                      ...
                      <div className="mt-2 flex items-center gap-3">
                        <button
                          onClick={() =>
                            navigate(`/workspace/novels/edit/${novel.id}`)
                          }
