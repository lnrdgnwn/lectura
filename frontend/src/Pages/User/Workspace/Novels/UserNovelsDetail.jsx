// components/UserNovelsDetail.jsx
...
export default function UserNovelsDetail() {
  ...
  const goEditChapter = (ch) =>
    navigate(`/workspace/novels/${novel.id}/edit-chapter/${ch.id}`);
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm">
        ...
        <div className="flex flex-wrap gap-3 justify-between items-center px-4 md:px-5 py-4 border-b border-gray-200">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <button
              onClick={() => navigate("/workspace/novels")}
          ...
          <div className="flex flex-wrap gap-2">
            <button
              onClick={() => navigate(`/workspace/novels/edit/${novel.id}`)}
            ...
            <button
              onClick={() => navigate(`/workspace/novels/${novel.id}/write`)}
              ...
              <>
                {draftChapters.length === 0 ? (
                  <>
                    ...
                    <button
                      onClick={() =>
                        navigate(`/workspace/novels/${novel.id}/write`)
                      }
